...
export interface Modificacion {
  ...
  anchoDelanteroAletines?: number;
  anchoTraseroAletines?: number;
  anchosDistintosAletines?: boolean;
  tipoFabricacionAletines?: string;
  materialAletines?: string;
  superficieFrontalM2AletinesDelantero?: number;
  superficieFrontalM2AletinesTrasero?: number;
  marcaDelanteroAletines?: string;
  marcaTraseroAletines?: string;
  referenciaDelanteroAletines?: string;
  referenciaTraseroAletines?: string;
  anchoSobrealetines?: number;
  anchoDelanteroSobrealetines?: number;
  anchoTraseroSobrealetines?: number;
  anchosDistintosSobrealetines?: boolean;
  tipoFabricacionSobrealetines?: string;
  materialSobrealetines?: string;
  neumaticosDistintosEjes?: boolean;
  medidaNeumaticoDelantero?: string;
  medidaLlantaDelantera?: string;
  medidaNeumaticoTrasero?: string;
